...
document.addEventListener('keydown', function(e) {
    if(e.keyCode === 37 && snake.dx === 0){ // to the left
        snake.dx = -grid;
        snake.dy = 0
    } else if(e.keyCode === 38 && snake.dy === 0){ // to the top
        snake.dy = -grid;
        snake.dx = 0
    }else if(e.keyCode === 39 && snake.dx === 0){ // to the right
        snake.dx = grid;
        snake.dy = 0
    }else if(e.keyCode === 40 && snake.dy === 0){ // down
        snake.dy = grid;
        snake.dx = 0
    }
})
